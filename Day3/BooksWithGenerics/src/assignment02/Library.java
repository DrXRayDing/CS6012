...
public class Library {
  ...
  public ArrayList<LibraryBook> lookup(String holder) {
    ArrayList<LibraryBook> booksCheckedOut = new ArrayList<>();
    for (LibraryBook book: library){
      if(book.getHolder() != null && book.getHolder().equals(holder)){ //Why need book.getHolder() != null?
  ...
  public boolean checkin(String holder) {
    ...
    return false;//If no book with the specified holder is in the library, returns false.
  }
}
